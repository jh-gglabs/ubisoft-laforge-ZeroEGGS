...
class ZeroEggsInference(object):
    ...
    def generate_gesture_from_audio_file(self, audio_file_path, style_bvh_path, style_encoding_type="example"):
        """
        Args:
    ...
    def _create_style_encoding(self, style_bvh_path, style_encoding_type="example", temperature=1.0):
...
if __name__ == "__main__":
    ...
    bvh_output = zeggs_module.generate_gesture_from_audio_file(audio_file_path, bvh_file_path)
